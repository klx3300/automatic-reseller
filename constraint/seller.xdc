...
# set_property PACKAGE_PIN U7 [get_ports {tickled[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {tickled[0]}]
# #Bank = 34, Pin name = IO_L22N_T3_34,Sch name = LED7
# set_property PACKAGE_PIN U6 [get_ports {tickled[1]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {tickled[1]}]
# #Bank = 34, Pin name = IO_L10N_T1_34,Sch name = LED8
# set_property PACKAGE_PIN V4 [get_ports {tickled[2]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {tickled[2]}]
# #Bank = 34, Pin name = IO_L8N_T1_34,Sch name = LED9
# set_property PACKAGE_PIN U3 [get_ports {tickled[3]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {tickled[3]}]
# ##Bank = 34, Pin name = IO_L7N_T1_34,Sch name = LED10
# #set_property PACKAGE_PIN V1 [get_ports {led[10]}]
# #set_property IOSTANDARD LVCMOS33 [get_ports {led[10]}]
# ##Bank = 34, Pin name = IO_L17P_T2_34,Sch name = LED11
# set_property PACKAGE_PIN R1 [get_ports btnstat]
# set_property IOSTANDARD LVCMOS33 [get_ports btnstat]
# ##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,Sch name = LED12
# set_property PACKAGE_PIN P5 [get_ports {stateled[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {stateled[0]}]
# #Bank = 34, Pin name = IO_L7P_T1_34,Sch name = LED13
# set_property PACKAGE_PIN U1 [get_ports {stateled[1]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {stateled[1]}]
# #Bank = 34, Pin name = IO_L15N_T2_DQS_34,Sch name = LED14
# set_property PACKAGE_PIN R2 [get_ports {stateled[2]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {stateled[2]}]
# #Bank = 34, Pin name = IO_L15P_T2_DQS_34,Sch name = LED15
# set_property PACKAGE_PIN P2 [get_ports startled]
...
set_property PACKAGE_PIN C12 [get_ports btnRst]
